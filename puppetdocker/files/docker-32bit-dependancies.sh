...
#            with a heads-up.
GO_VERSION=1.6.3
curl -fsSL "https://storage.googleapis.com/golang/go${GO_VERSION}.linux-386.tar.gz" \
	| tar -xzC /usr/local
...
DOCKER_PY_COMMIT=7befe694bd21e3c54bb1d7825270ea4bd6864c13
...
# Install containerd
CONTAINERD_COMMIT=0ac3cd1be170d180b2baed755e8f0da547ceb267
set -x \
	&& export GOPATH="$(mktemp -d)" \
